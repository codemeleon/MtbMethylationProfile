...
sd = "raw_data" # Change you folder path here
common_folder = "common_folder" # Change you folder path here
pf = f"{common_folder}/ProteinTable.txt"
gf = f"{common_folder}/genes"
gs = "all" #gene, 5utr
of = f"{common_folder}/Operon_locations.tsv"
upstrm = 100
rgd=f"{common_folder}/selected_genes"
outgroup = f"{common_folder}/NC_015848.1.fna" #  Name should be the same as sequence name
